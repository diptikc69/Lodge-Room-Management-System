...
<?php session_start(); ?>
    ...
    <title>Admin - Lodge <?php echo $title;?></title>

    <!-- Bootstrap Core CSS -->
    <link href="/lodge/admin/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="/lodge/admin/assets/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/lodge/admin/assets/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/lodge/admin/assets/vendor/morrisjs/morris.css" rel="stylesheet">
